...
const AssignmentSubmission = () => {
    ...
    useEffect(() => {
        const fetchAssignment = async () => {
            try {
                const response = await fetch(`https://assignment-portal-ruby.vercel.app/api/particular/${assignmentId}`);
                if (!response.ok) {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch('https://assignment-portal-ruby.vercel.app/api/submit', {
                method: 'POST',
                body: formData,
            });
