...
const AssignmentsWithLeaderboard = ({ studentId }) => {
  ...
  useEffect(() => {
    ...
    const fetchAssignments = async () => {
      try {
        const response = await fetch(`https://assignment-portal-ruby.vercel.app/api/studentAssignments/${studentId}`);
  ...
  const handleViewLeaderboard = async (assignmentId, assignmentTitle) => {
    try {
      const response = await fetch(`https://assignment-portal-ruby.vercel.app/api/leaderboard/${assignmentId}`);
      const data = await response.json();
